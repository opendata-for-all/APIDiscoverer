...
/**
 * This is the item provider adapter for a {@link core.ArrayContext} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ArrayContextItemProvider 
	 ...
	 * @generated
	 */
	public ArrayContextItemProvider(AdapterFactory adapterFactory) {
	...
	public String getText(Object object) {
		CollectionFormat labelValue = ((ArrayContext)object).getCollectionFormat();
		String label = labelValue == null ? null : labelValue.toString();
		return label == null || label.length() == 0 ?
			getString("_UI_ArrayContext_type") :
			getString("_UI_ArrayContext_type") + " " + label;
	}
