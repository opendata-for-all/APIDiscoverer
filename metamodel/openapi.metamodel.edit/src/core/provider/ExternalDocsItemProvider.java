...
/**
 * This is the item provider adapter for a {@link core.ExternalDocs} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ExternalDocsItemProvider 
	 ...
	 * @generated
	 */
	public ExternalDocsItemProvider(AdapterFactory adapterFactory) {
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/ExternalDocs"));
	}
	...
	public String getText(Object object) {
		String label = ((ExternalDocs)object).getDescription();
		return label == null || label.length() == 0 ?
			getString("_UI_ExternalDocs_type") :
			getString("_UI_ExternalDocs_type") + " " + label;
	}
