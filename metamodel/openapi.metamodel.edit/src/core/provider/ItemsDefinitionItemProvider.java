...
/**
 * This is the item provider adapter for a {@link core.ItemsDefinition} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ItemsDefinitionItemProvider extends JSONSchemaSubsetItemProvider {
	/**
	 ...
	 * @generated
	 */
	public ItemsDefinitionItemProvider(AdapterFactory adapterFactory) {
	...
	/**
	 * This returns ItemsDefinition.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/ItemsDefinition"));
	}
	...
	public String getText(Object object) {
		JSONDataType labelValue = ((ItemsDefinition)object).getType();
		String label = labelValue == null ? null : labelValue.toString();
		return label == null || label.length() == 0 ?
			getString("_UI_ItemsDefinition_type") :
			getString("_UI_ItemsDefinition_type") + " " + label;
	}
