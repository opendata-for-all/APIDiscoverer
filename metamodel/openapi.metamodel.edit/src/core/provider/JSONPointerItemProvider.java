...
/**
 * This is the item provider adapter for a {@link core.JSONPointer} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class JSONPointerItemProvider 
	 ...
	 * @generated
	 */
	public JSONPointerItemProvider(AdapterFactory adapterFactory) {
	...
	public String getText(Object object) {
		String label = ((JSONPointer)object).getRef();
		return label == null || label.length() == 0 ?
			getString("_UI_JSONPointer_type") :
			getString("_UI_JSONPointer_type") + " " + label;
	}
