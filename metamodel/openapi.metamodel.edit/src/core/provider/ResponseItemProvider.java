...
public class ResponseItemProvider extends SchemaDeclaringContextItemProvider {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 CorePackage.Literals.RESPONSE__DESCRIPTION,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 CorePackage.Literals.RESPONSE__CODE,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(CorePackage.Literals.RESPONSE__HEADERS);
			childrenFeatures.add(CorePackage.Literals.RESPONSE__EXAMPLES);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(CorePackage.Literals.RESPONSE__HEADERS,
				 CoreFactory.eINSTANCE.createHeader()));

		newChildDescriptors.add
			(createChildParameter
				(CorePackage.Literals.RESPONSE__EXAMPLES,
