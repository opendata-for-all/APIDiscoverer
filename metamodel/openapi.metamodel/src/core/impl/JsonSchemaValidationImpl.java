...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Json Schema Validation</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link core.impl.JsonSchemaValidationImpl#getMaximum <em>Maximum</em>}</li>
 *   <li>{@link core.impl.JsonSchemaValidationImpl#getExclusiveMaximum <em>Exclusive Maximum</em>}</li>
 *   <li>{@link core.impl.JsonSchemaValidationImpl#getMinimum <em>Minimum</em>}</li>
 *   <li>{@link core.impl.JsonSchemaValidationImpl#getExclusiveMinimum <em>Exclusive Minimum</em>}</li>
 *   <li>{@link core.impl.JsonSchemaValidationImpl#getMaxLength <em>Max Length</em>}</li>
 *   <li>{@link core.impl.JsonSchemaValidationImpl#getMinLength <em>Min Length</em>}</li>
 *   <li>{@link core.impl.JsonSchemaValidationImpl#getPattern <em>Pattern</em>}</li>
 *   <li>{@link core.impl.JsonSchemaValidationImpl#getMaxItems <em>Max Items</em>}</li>
 *   <li>{@link core.impl.JsonSchemaValidationImpl#getMinItems <em>Min Items</em>}</li>
 *   <li>{@link core.impl.JsonSchemaValidationImpl#getUniqueItems <em>Unique Items</em>}</li>
 *   <li>{@link core.impl.JsonSchemaValidationImpl#getEnum <em>Enum</em>}</li>
 *   <li>{@link core.impl.JsonSchemaValidationImpl#getMultipleOf <em>Multiple Of</em>}</li>
 * </ul>
 *
 * @generated
 */
public abstract class JsonSchemaValidationImpl extends MinimalEObjectImpl.Container implements JsonSchemaValidation {
	/**
	 ...
	 * @generated
	 */
	protected JsonSchemaValidationImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return CorePackage.Literals.JSON_SCHEMA_VALIDATION;
	}
	...
	public void setMaximum(Double newMaximum) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CorePackage.JSON_SCHEMA_VALIDATION__MAXIMUM, oldMaximum, maximum));
	}
	...
	public void setExclusiveMaximum(Double newExclusiveMaximum) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CorePackage.JSON_SCHEMA_VALIDATION__EXCLUSIVE_MAXIMUM, oldExclusiveMaximum, exclusiveMaximum));
	}
	...
	public void setMinimum(Double newMinimum) {
		...
		minimum = newMinimum;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CorePackage.JSON_SCHEMA_VALIDATION__MINIMUM, oldMinimum, minimum));
	}
	...
	public void setExclusiveMinimum(Boolean newExclusiveMinimum) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CorePackage.JSON_SCHEMA_VALIDATION__EXCLUSIVE_MINIMUM, oldExclusiveMinimum, exclusiveMinimum));
	}
	...
	public void setMaxLength(Integer newMaxLength) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CorePackage.JSON_SCHEMA_VALIDATION__MAX_LENGTH, oldMaxLength, maxLength));
	}
	...
	public void setMinLength(Integer newMinLength) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CorePackage.JSON_SCHEMA_VALIDATION__MIN_LENGTH, oldMinLength, minLength));
	}
	...
	public void setPattern(String newPattern) {
		...
		pattern = newPattern;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CorePackage.JSON_SCHEMA_VALIDATION__PATTERN, oldPattern, pattern));
	}
	...
	public void setMaxItems(Integer newMaxItems) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CorePackage.JSON_SCHEMA_VALIDATION__MAX_ITEMS, oldMaxItems, maxItems));
	}
	...
	public void setMinItems(Integer newMinItems) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CorePackage.JSON_SCHEMA_VALIDATION__MIN_ITEMS, oldMinItems, minItems));
	}
	...
	public void setUniqueItems(Boolean newUniqueItems) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CorePackage.JSON_SCHEMA_VALIDATION__UNIQUE_ITEMS, oldUniqueItems, uniqueItems));
	}
	...
	public EList<String> getEnum() {
		if (enum_ == null) {
			enum_ = new EDataTypeUniqueEList<String>(String.class, this, CorePackage.JSON_SCHEMA_VALIDATION__ENUM);
		}
		return enum_;
	}
	...
	public void setMultipleOf(double newMultipleOf) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CorePackage.JSON_SCHEMA_VALIDATION__MULTIPLE_OF, oldMultipleOf, multipleOf));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case CorePackage.JSON_SCHEMA_VALIDATION__MAXIMUM:
				return getMaximum();
			case CorePackage.JSON_SCHEMA_VALIDATION__EXCLUSIVE_MAXIMUM:
				return getExclusiveMaximum();
			case CorePackage.JSON_SCHEMA_VALIDATION__MINIMUM:
				return getMinimum();
			case CorePackage.JSON_SCHEMA_VALIDATION__EXCLUSIVE_MINIMUM:
				return getExclusiveMinimum();
			case CorePackage.JSON_SCHEMA_VALIDATION__MAX_LENGTH:
				return getMaxLength();
			case CorePackage.JSON_SCHEMA_VALIDATION__MIN_LENGTH:
				return getMinLength();
			case CorePackage.JSON_SCHEMA_VALIDATION__PATTERN:
				return getPattern();
			case CorePackage.JSON_SCHEMA_VALIDATION__MAX_ITEMS:
				return getMaxItems();
			case CorePackage.JSON_SCHEMA_VALIDATION__MIN_ITEMS:
				return getMinItems();
			case CorePackage.JSON_SCHEMA_VALIDATION__UNIQUE_ITEMS:
				return getUniqueItems();
			case CorePackage.JSON_SCHEMA_VALIDATION__ENUM:
				return getEnum();
			case CorePackage.JSON_SCHEMA_VALIDATION__MULTIPLE_OF:
