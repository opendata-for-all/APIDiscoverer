 ...
 * <!-- end-user-doc -->
 * @see core.OpenAPIPackage
 * @generated
 */
public class OpenAPIValidator extends EObjectValidator {
	/**
	 ...
	 * @generated
	 */
	public static final OpenAPIValidator INSTANCE = new OpenAPIValidator();
	...
	protected boolean validate(int classifierID, Object value, DiagnosticChain diagnostics, Map<Object, Object> context) {
		switch (classifierID) {
			...
			case OpenAPIPackage.ITEMS_DEFINITION:
			...
			case OpenAPIPackage.SCHEMA_CONTEXT:
				return validateSchemaContext((SchemaContext)value, diagnostics, context);
			case OpenAPIPackage.EXTERNAL_DOCS_CONTEXT:
	...
	public boolean validateAPI_requiredSwaggerVersion(API api, DiagnosticChain diagnostics, Map<Object, Object> context) {
        if (api_requiredSwaggerVersionInvOCL == null) {
			...
			helper.setContext(OpenAPIPackage.Literals.API);
			
			EAnnotation ocl = OpenAPIPackage.Literals.API.getEAnnotation(OCL_ANNOTATION_SOURCE);
	...
	public boolean validateInfo_requiredTitle(Info info, DiagnosticChain diagnostics, Map<Object, Object> context) {
        if (info_requiredTitleInvOCL == null) {
			OCL.Helper helper = OCL_ENV.createOCLHelper();
			helper.setContext(OpenAPIPackage.Literals.INFO);
			
			EAnnotation ocl = OpenAPIPackage.Literals.INFO.getEAnnotation(OCL_ANNOTATION_SOURCE);
	...
	public boolean validateLicense_requiredName(License license, DiagnosticChain diagnostics, Map<Object, Object> context) {
        if (license_requiredNameInvOCL == null) {
			OCL.Helper helper = OCL_ENV.createOCLHelper();
			helper.setContext(OpenAPIPackage.Literals.LICENSE);
			
			EAnnotation ocl = OpenAPIPackage.Literals.LICENSE.getEAnnotation(OCL_ANNOTATION_SOURCE);
	...
	public boolean validateOperation_oneBodyParameterAllowed(Operation operation, DiagnosticChain diagnostics, Map<Object, Object> context) {
        if (operation_oneBodyParameterAllowedInvOCL == null) {
			OCL.Helper helper = OCL_ENV.createOCLHelper();
			helper.setContext(OpenAPIPackage.Literals.OPERATION);
			
			EAnnotation ocl = OpenAPIPackage.Literals.OPERATION.getEAnnotation(OCL_ANNOTATION_SOURCE);
	...
	public boolean validateExternalDocs_requiredURL(ExternalDocs externalDocs, DiagnosticChain diagnostics, Map<Object, Object> context) {
        if (externalDocs_requiredURLInvOCL == null) {
			OCL.Helper helper = OCL_ENV.createOCLHelper();
			helper.setContext(OpenAPIPackage.Literals.EXTERNAL_DOCS);
			
			EAnnotation ocl = OpenAPIPackage.Literals.EXTERNAL_DOCS.getEAnnotation(OCL_ANNOTATION_SOURCE);
	...
	public boolean validateParameter_requiredName(Parameter parameter, DiagnosticChain diagnostics, Map<Object, Object> context) {
        if (parameter_requiredNameInvOCL == null) {
			OCL.Helper helper = OCL_ENV.createOCLHelper();
			helper.setContext(OpenAPIPackage.Literals.PARAMETER);
			
			EAnnotation ocl = OpenAPIPackage.Literals.PARAMETER.getEAnnotation(OCL_ANNOTATION_SOURCE);
			String expr = ocl.getDetails().get("requiredName");
