 ...
 * </p>
 * <ul>
 *   <li>{@link som.swagger.core.impl.ApiImpl#getSwagger <em>Swagger</em>}</li>
 *   <li>{@link som.swagger.core.impl.ApiImpl#getInfo <em>Info</em>}</li>
 *   <li>{@link som.swagger.core.impl.ApiImpl#getHost <em>Host</em>}</li>
 *   <li>{@link som.swagger.core.impl.ApiImpl#getBasePath <em>Base Path</em>}</li>
 *   <li>{@link som.swagger.core.impl.ApiImpl#getSchemes <em>Schemes</em>}</li>
 *   <li>{@link som.swagger.core.impl.ApiImpl#getConsumes <em>Consumes</em>}</li>
 *   <li>{@link som.swagger.core.impl.ApiImpl#getProduces <em>Produces</em>}</li>
 *   <li>{@link som.swagger.core.impl.ApiImpl#getPaths <em>Paths</em>}</li>
 *   <li>{@link som.swagger.core.impl.ApiImpl#getDefinitions <em>Definitions</em>}</li>
 *   <li>{@link som.swagger.core.impl.ApiImpl#getParameters <em>Parameters</em>}</li>
 *   <li>{@link som.swagger.core.impl.ApiImpl#getResponses <em>Responses</em>}</li>
 *   <li>{@link som.swagger.core.impl.ApiImpl#getSecurityDefinitions <em>Security Definitions</em>}</li>
 *   <li>{@link som.swagger.core.impl.ApiImpl#getSecurity <em>Security</em>}</li>
 *   <li>{@link som.swagger.core.impl.ApiImpl#getExternaldocs <em>Externaldocs</em>}</li>
 *   <li>{@link som.swagger.core.impl.ApiImpl#getTag <em>Tag</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ApiImpl extends MinimalEObjectImpl.Container implements Api {
	...
	public EList<Parameter> getParameters() {
		if (parameters == null) {
			parameters = new EObjectContainmentEList<Parameter>(Parameter.class, this, CorePackage.API__PARAMETERS);
		}
		return parameters;
	}
