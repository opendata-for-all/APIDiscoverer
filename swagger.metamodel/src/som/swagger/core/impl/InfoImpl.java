 ...
 * </p>
 * <ul>
 *   <li>{@link som.swagger.core.impl.InfoImpl#getTitle <em>Title</em>}</li>
 *   <li>{@link som.swagger.core.impl.InfoImpl#getDescription <em>Description</em>}</li>
 *   <li>{@link som.swagger.core.impl.InfoImpl#getTermsOfServices <em>Terms Of Services</em>}</li>
 *   <li>{@link som.swagger.core.impl.InfoImpl#getContact <em>Contact</em>}</li>
 *   <li>{@link som.swagger.core.impl.InfoImpl#getLicense <em>License</em>}</li>
 *   <li>{@link som.swagger.core.impl.InfoImpl#getVersion <em>Version</em>}</li>
 * </ul>
 *
 * @generated
 */
