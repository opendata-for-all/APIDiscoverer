 ...
 * </p>
 * <ul>
 *   <li>{@link som.swagger.core.impl.ItemsImpl#getType <em>Type</em>}</li>
 *   <li>{@link som.swagger.core.impl.ItemsImpl#getFormat <em>Format</em>}</li>
 *   <li>{@link som.swagger.core.impl.ItemsImpl#getItems <em>Items</em>}</li>
 *   <li>{@link som.swagger.core.impl.ItemsImpl#getCollectionFormat <em>Collection Format</em>}</li>
 *   <li>{@link som.swagger.core.impl.ItemsImpl#getMaximum <em>Maximum</em>}</li>
 *   <li>{@link som.swagger.core.impl.ItemsImpl#isExclusiveMaximum <em>Exclusive Maximum</em>}</li>
 *   <li>{@link som.swagger.core.impl.ItemsImpl#getMinimum <em>Minimum</em>}</li>
 *   <li>{@link som.swagger.core.impl.ItemsImpl#isExclusiveMinimum <em>Exclusive Minimum</em>}</li>
 *   <li>{@link som.swagger.core.impl.ItemsImpl#getMaxLength <em>Max Length</em>}</li>
 *   <li>{@link som.swagger.core.impl.ItemsImpl#getMinLength <em>Min Length</em>}</li>
 *   <li>{@link som.swagger.core.impl.ItemsImpl#getPattern <em>Pattern</em>}</li>
 *   <li>{@link som.swagger.core.impl.ItemsImpl#getMaxItems <em>Max Items</em>}</li>
 *   <li>{@link som.swagger.core.impl.ItemsImpl#getMinItems <em>Min Items</em>}</li>
 *   <li>{@link som.swagger.core.impl.ItemsImpl#isUniqueItems <em>Unique Items</em>}</li>
 *   <li>{@link som.swagger.core.impl.ItemsImpl#getMultipleOf <em>Multiple Of</em>}</li>
 *   <li>{@link som.swagger.core.impl.ItemsImpl#getDefault <em>Default</em>}</li>
 *   <li>{@link som.swagger.core.impl.ItemsImpl#getEnum <em>Enum</em>}</li>
 * </ul>
 *
 * @generated
 */
