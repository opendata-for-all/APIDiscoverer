 ...
 * </p>
 * <ul>
 *   <li>{@link som.swagger.core.impl.ParameterImpl#getName <em>Name</em>}</li>
 *   <li>{@link som.swagger.core.impl.ParameterImpl#getIn <em>In</em>}</li>
 *   <li>{@link som.swagger.core.impl.ParameterImpl#getDescription <em>Description</em>}</li>
 *   <li>{@link som.swagger.core.impl.ParameterImpl#isRequired <em>Required</em>}</li>
 *   <li>{@link som.swagger.core.impl.ParameterImpl#getType <em>Type</em>}</li>
 *   <li>{@link som.swagger.core.impl.ParameterImpl#getFormat <em>Format</em>}</li>
 *   <li>{@link som.swagger.core.impl.ParameterImpl#isAllowEmplyValue <em>Allow Emply Value</em>}</li>
 *   <li>{@link som.swagger.core.impl.ParameterImpl#getItems <em>Items</em>}</li>
 *   <li>{@link som.swagger.core.impl.ParameterImpl#getCollectionFormat <em>Collection Format</em>}</li>
 *   <li>{@link som.swagger.core.impl.ParameterImpl#getMaximum <em>Maximum</em>}</li>
 *   <li>{@link som.swagger.core.impl.ParameterImpl#isExclusiveMaximum <em>Exclusive Maximum</em>}</li>
 *   <li>{@link som.swagger.core.impl.ParameterImpl#getMinimum <em>Minimum</em>}</li>
 *   <li>{@link som.swagger.core.impl.ParameterImpl#isExclusiveMinimum <em>Exclusive Minimum</em>}</li>
 *   <li>{@link som.swagger.core.impl.ParameterImpl#getMaxLength <em>Max Length</em>}</li>
 *   <li>{@link som.swagger.core.impl.ParameterImpl#getMinLength <em>Min Length</em>}</li>
 *   <li>{@link som.swagger.core.impl.ParameterImpl#getPattern <em>Pattern</em>}</li>
 *   <li>{@link som.swagger.core.impl.ParameterImpl#getMaxItems <em>Max Items</em>}</li>
 *   <li>{@link som.swagger.core.impl.ParameterImpl#getMinItems <em>Min Items</em>}</li>
 *   <li>{@link som.swagger.core.impl.ParameterImpl#isUniqueItems <em>Unique Items</em>}</li>
 *   <li>{@link som.swagger.core.impl.ParameterImpl#getMultipleOf <em>Multiple Of</em>}</li>
 *   <li>{@link som.swagger.core.impl.ParameterImpl#getSchema <em>Schema</em>}</li>
 *   <li>{@link som.swagger.core.impl.ParameterImpl#getDefault <em>Default</em>}</li>
 *   <li>{@link som.swagger.core.impl.ParameterImpl#getEnum <em>Enum</em>}</li>
 *   <li>{@link som.swagger.core.impl.ParameterImpl#getGlobalName <em>Global Name</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ParameterImpl extends MinimalEObjectImpl.Container implements Parameter {
	...
	public void setIn(ParameterLocation newIn) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CorePackage.PARAMETER__IN, oldIn, in));
	}
	...
	public NotificationChain basicSetSchema(Schema newSchema, NotificationChain msgs) {
		...
		schema = newSchema;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, CorePackage.PARAMETER__SCHEMA, oldSchema, newSchema);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setSchema(Schema newSchema) {
		if (newSchema != schema) {
			NotificationChain msgs = null;
			if (schema != null)
				msgs = ((InternalEObject)schema).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - CorePackage.PARAMETER__SCHEMA, null, msgs);
			if (newSchema != null)
				msgs = ((InternalEObject)newSchema).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - CorePackage.PARAMETER__SCHEMA, null, msgs);
			msgs = basicSetSchema(newSchema, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CorePackage.PARAMETER__SCHEMA, newSchema, newSchema));
	}
	...
	public void setGlobalName(String newGlobalName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CorePackage.PARAMETER__GLOBAL_NAME, oldGlobalName, globalName));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case CorePackage.PARAMETER__NAME:
				return getName();
			case CorePackage.PARAMETER__IN:
				return getIn();
			...
			case CorePackage.PARAMETER__ENUM:
				return getEnum();
			case CorePackage.PARAMETER__GLOBAL_NAME:
