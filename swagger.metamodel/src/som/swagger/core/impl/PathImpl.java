 ...
 * </p>
 * <ul>
 *   <li>{@link som.swagger.core.impl.PathImpl#getPattern <em>Pattern</em>}</li>
 *   <li>{@link som.swagger.core.impl.PathImpl#getPut <em>Put</em>}</li>
 *   <li>{@link som.swagger.core.impl.PathImpl#getGet <em>Get</em>}</li>
 *   <li>{@link som.swagger.core.impl.PathImpl#getDelete <em>Delete</em>}</li>
 *   <li>{@link som.swagger.core.impl.PathImpl#getOptions <em>Options</em>}</li>
 *   <li>{@link som.swagger.core.impl.PathImpl#getParameters <em>Parameters</em>}</li>
 *   <li>{@link som.swagger.core.impl.PathImpl#getHead <em>Head</em>}</li>
 *   <li>{@link som.swagger.core.impl.PathImpl#getPost <em>Post</em>}</li>
 *   <li>{@link som.swagger.core.impl.PathImpl#getPatch <em>Patch</em>}</li>
 *   <li>{@link som.swagger.core.impl.PathImpl#getRef <em>Ref</em>}</li>
 * </ul>
 *
 * @generated
 */
public class PathImpl extends MinimalEObjectImpl.Container implements Path {
	...
	public EList<Parameter> getParameters() {
		if (parameters == null) {
			parameters = new EObjectContainmentEList<Parameter>(Parameter.class, this, CorePackage.PATH__PARAMETERS);
		}
		return parameters;
	}
