 ...
 * </p>
 * <ul>
 *   <li>{@link som.swagger.core.impl.ResponseImpl#getDescription <em>Description</em>}</li>
 *   <li>{@link som.swagger.core.impl.ResponseImpl#getSchema <em>Schema</em>}</li>
 *   <li>{@link som.swagger.core.impl.ResponseImpl#getHeaders <em>Headers</em>}</li>
 *   <li>{@link som.swagger.core.impl.ResponseImpl#getExamples <em>Examples</em>}</li>
 *   <li>{@link som.swagger.core.impl.ResponseImpl#getCode <em>Code</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ResponseImpl extends MinimalEObjectImpl.Container implements Response {
	...
	public EList<Header> getHeaders() {
		if (headers == null) {
			headers = new EObjectResolvingEList<Header>(Header.class, this, CorePackage.RESPONSE__HEADERS);
		}
		return headers;
	}
