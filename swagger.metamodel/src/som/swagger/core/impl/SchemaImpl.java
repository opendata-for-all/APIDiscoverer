 ...
 * </p>
 * <ul>
 *   <li>{@link som.swagger.core.impl.SchemaImpl#getFormat <em>Format</em>}</li>
 *   <li>{@link som.swagger.core.impl.SchemaImpl#getTitle <em>Title</em>}</li>
 *   <li>{@link som.swagger.core.impl.SchemaImpl#getDescription <em>Description</em>}</li>
 *   <li>{@link som.swagger.core.impl.SchemaImpl#getMultipleOf <em>Multiple Of</em>}</li>
 *   <li>{@link som.swagger.core.impl.SchemaImpl#getMaximum <em>Maximum</em>}</li>
 *   <li>{@link som.swagger.core.impl.SchemaImpl#isExclusiveMaximum <em>Exclusive Maximum</em>}</li>
 *   <li>{@link som.swagger.core.impl.SchemaImpl#getMaxLength <em>Max Length</em>}</li>
 *   <li>{@link som.swagger.core.impl.SchemaImpl#getMinLength <em>Min Length</em>}</li>
 *   <li>{@link som.swagger.core.impl.SchemaImpl#getPattern <em>Pattern</em>}</li>
 *   <li>{@link som.swagger.core.impl.SchemaImpl#getMinimum <em>Minimum</em>}</li>
 *   <li>{@link som.swagger.core.impl.SchemaImpl#isExclusiveMinimum <em>Exclusive Minimum</em>}</li>
 *   <li>{@link som.swagger.core.impl.SchemaImpl#getMaxItems <em>Max Items</em>}</li>
 *   <li>{@link som.swagger.core.impl.SchemaImpl#getMinItems <em>Min Items</em>}</li>
 *   <li>{@link som.swagger.core.impl.SchemaImpl#isUniqueItems <em>Unique Items</em>}</li>
 *   <li>{@link som.swagger.core.impl.SchemaImpl#getMaxProperties <em>Max Properties</em>}</li>
 *   <li>{@link som.swagger.core.impl.SchemaImpl#getMinProperties <em>Min Properties</em>}</li>
 *   <li>{@link som.swagger.core.impl.SchemaImpl#getRequired <em>Required</em>}</li>
 *   <li>{@link som.swagger.core.impl.SchemaImpl#getType <em>Type</em>}</li>
 *   <li>{@link som.swagger.core.impl.SchemaImpl#getProperties <em>Properties</em>}</li>
 *   <li>{@link som.swagger.core.impl.SchemaImpl#getExample <em>Example</em>}</li>
 *   <li>{@link som.swagger.core.impl.SchemaImpl#getEnum <em>Enum</em>}</li>
 *   <li>{@link som.swagger.core.impl.SchemaImpl#getExternaldocs <em>Externaldocs</em>}</li>
 *   <li>{@link som.swagger.core.impl.SchemaImpl#getAllOf <em>All Of</em>}</li>
 *   <li>{@link som.swagger.core.impl.SchemaImpl#getRef <em>Ref</em>}</li>
 *   <li>{@link som.swagger.core.impl.SchemaImpl#getDefault <em>Default</em>}</li>
 *   <li>{@link som.swagger.core.impl.SchemaImpl#getItems <em>Items</em>}</li>
 *   <li>{@link som.swagger.core.impl.SchemaImpl#getAdditonalProperties <em>Additonal Properties</em>}</li>
 *   <li>{@link som.swagger.core.impl.SchemaImpl#getDiscriminator <em>Discriminator</em>}</li>
 *   <li>{@link som.swagger.core.impl.SchemaImpl#isReadOnly <em>Read Only</em>}</li>
 *   <li>{@link som.swagger.core.impl.SchemaImpl#getXml <em>Xml</em>}</li>
 *   <li>{@link som.swagger.core.impl.SchemaImpl#getName <em>Name</em>}</li>
 * </ul>
 *
 * @generated
 */
public class SchemaImpl extends MinimalEObjectImpl.Container implements Schema {
	...
	public EList<Schema> getProperties() {
		if (properties == null) {
			properties = new EObjectContainmentEList<Schema>(Schema.class, this, CorePackage.SCHEMA__PROPERTIES);
		}
		return properties;
	}
	...
	public EList<Schema> getItems() {
		if (items == null) {
			items = new EObjectContainmentEList<Schema>(Schema.class, this, CorePackage.SCHEMA__ITEMS);
		}
		return items;
	}
