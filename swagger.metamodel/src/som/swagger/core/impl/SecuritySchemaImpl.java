 ...
 * </p>
 * <ul>
 *   <li>{@link som.swagger.core.impl.SecuritySchemaImpl#getType <em>Type</em>}</li>
 *   <li>{@link som.swagger.core.impl.SecuritySchemaImpl#getDescription <em>Description</em>}</li>
 *   <li>{@link som.swagger.core.impl.SecuritySchemaImpl#getName <em>Name</em>}</li>
 *   <li>{@link som.swagger.core.impl.SecuritySchemaImpl#getIn <em>In</em>}</li>
 *   <li>{@link som.swagger.core.impl.SecuritySchemaImpl#getFlow <em>Flow</em>}</li>
 *   <li>{@link som.swagger.core.impl.SecuritySchemaImpl#getAuthorizationUrl <em>Authorization Url</em>}</li>
 *   <li>{@link som.swagger.core.impl.SecuritySchemaImpl#getTokenUrl <em>Token Url</em>}</li>
 *   <li>{@link som.swagger.core.impl.SecuritySchemaImpl#getGlobalName <em>Global Name</em>}</li>
 *   <li>{@link som.swagger.core.impl.SecuritySchemaImpl#getScopes <em>Scopes</em>}</li>
 * </ul>
 *
 * @generated
 */
