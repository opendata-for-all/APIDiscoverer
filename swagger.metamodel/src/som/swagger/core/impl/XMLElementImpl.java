 ...
 * </p>
 * <ul>
 *   <li>{@link som.swagger.core.impl.XMLElementImpl#getName <em>Name</em>}</li>
 *   <li>{@link som.swagger.core.impl.XMLElementImpl#getNamespace <em>Namespace</em>}</li>
 *   <li>{@link som.swagger.core.impl.XMLElementImpl#getPrefix <em>Prefix</em>}</li>
 *   <li>{@link som.swagger.core.impl.XMLElementImpl#isAttribute <em>Attribute</em>}</li>
 *   <li>{@link som.swagger.core.impl.XMLElementImpl#isWrapped <em>Wrapped</em>}</li>
 * </ul>
 *
 * @generated
 */
public class XMLElementImpl extends MinimalEObjectImpl.Container implements XMLElement {
	...
	protected EClass eStaticClass() {
		return CorePackage.Literals.XML_ELEMENT;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CorePackage.XML_ELEMENT__NAME, oldName, name));
	}
	...
	public void setNamespace(String newNamespace) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CorePackage.XML_ELEMENT__NAMESPACE, oldNamespace, namespace));
	}
	...
	public void setPrefix(String newPrefix) {
		...
		prefix = newPrefix;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CorePackage.XML_ELEMENT__PREFIX, oldPrefix, prefix));
	}
	...
	public void setAttribute(boolean newAttribute) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CorePackage.XML_ELEMENT__ATTRIBUTE, oldAttribute, attribute));
	}
	...
	public void setWrapped(boolean newWrapped) {
		...
		wrapped = newWrapped;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CorePackage.XML_ELEMENT__WRAPPED, oldWrapped, wrapped));
	}
